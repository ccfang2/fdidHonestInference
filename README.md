...
This is a shiny app that facilitates the honest causal inference approach proposed in Fang and Liebl (2026)[^1] and is built on the R package: [fdid](https://github.com/ccfang2/fdid). 
